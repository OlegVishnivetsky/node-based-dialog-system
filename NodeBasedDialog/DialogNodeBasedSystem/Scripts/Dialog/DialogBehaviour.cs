...
namespace cherrydev
{
    public class DialogBehaviour : MonoBehaviour
    {
        ...
        public event Action OnConnectionNodeActive;
        ...
        private IEnumerator WriteDialogTextRoutine(string text)
        {
            ...
            // yield return new WaitUntil(() => FindObjectOfType<DialogDisplayer>().isEnabled == true);


            // Wait until the current collision trigger is activated
